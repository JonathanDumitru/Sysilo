  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-400">Catalog, lineage, and quality for your data assets</p>
      </div>

      {/* Stats */}
      <div className="grid grid-cols-4 gap-4">
        <div className="bg-surface-raised/80 backdrop-blur-glass rounded-xl p-5 shadow-glass border border-surface-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Data Entities</p>
            </div>
          </div>
        </div>
        <div className="bg-surface-raised/80 backdrop-blur-glass rounded-xl p-5 shadow-glass border border-surface-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Lineage Links</p>
            </div>
          </div>
        </div>
        <div className="bg-surface-raised/80 backdrop-blur-glass rounded-xl p-5 shadow-glass border border-surface-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">PII Fields</p>
            </div>
          </div>
        </div>
        <div className="bg-surface-raised/80 backdrop-blur-glass rounded-xl p-5 shadow-glass border border-surface-border">
      ...
      <div className="bg-surface-raised/80 backdrop-blur-glass rounded-xl shadow-glass border border-surface-border">
        <div className="p-4 border-b border-surface-border">
          <h2 className="text-lg font-semibold text-white">Data Catalog</h2>
        </div>
        <table className="w-full">
          ...
          <tbody className="divide-y divide-surface-border">
            {entities.map((entity) => (
              <tr key={entity.id} className="hover:bg-white/5 cursor-pointer">
                <td className="px-6 py-4">
                  <p className="text-sm font-medium text-white">{entity.name}</p>
                </td>
                <td className="px-6 py-4">
                  <span className="text-xs font-medium px-2 py-1 bg-gray-700/50 text-gray-400 rounded">{entity.type}</span>
                </td>
                <td className="px-6 py-4">
                  <span className="text-sm text-gray-400">{entity.source}</span>
                </td>
                <td className="px-6 py-4">
                  <span className="text-sm text-gray-400">{entity.records}</span>
                </td>
                <td className="px-6 py-4">
                  <span className="text-sm text-gray-400">{entity.lastSync}</span>
                </td>
                <td className="px-6 py-4">
                  <div className="flex items-center gap-2">
                    <div className="w-16 h-2 bg-surface-overlay rounded-full overflow-hidden">
                      <div
                    ...
                    <span className="text-xs text-gray-400">{entity.quality}%</span>
                  </div>
                </td>
              </tr>
            ))}
