  ...
  const commands = useMemo<Command[]>(() => {
    ...
    return [
      ...
      },
      {
        ...
        keywords: ['automation', 'workflow', 'runbook'],
      },
      {
        id: 'nav-standards',
        label: 'Go to Standards',
        description: 'Governance standards library',
        icon: BookOpen,
        category: 'navigation',
        action: nav('/governance/standards'),
        keywords: ['requirements', 'framework'],
      },
      {
        id: 'nav-approvals',
        ...
        keywords: ['pending', 'review', 'request'],
      },
      {
        id: 'nav-compliance-api',
        label: 'Go to Compliance API',
        description: 'Compliance scoring and policy decisions',
        icon: ShieldCheck,
        category: 'navigation',
        action: nav('/governance/compliance-api'),
        keywords: ['compliance', 'regulatory', 'api'],
      },
      {
        id: 'nav-applications',
        ...
        icon: Layers,
        category: 'navigation',
        action: nav('/rationalization/applications'),
        keywords: ['portfolio', 'apps', 'TIME'],
      },
      {
        id: 'nav-scenarios',
        ...
        icon: GitBranch,
        category: 'navigation',
        action: nav('/rationalization/scenarios'),
        keywords: ['what-if', 'simulation', 'compare'],
      },
      {
        id: 'nav-rat-playbooks',
        label: 'Go to Rationalization Playbooks',
        description: 'Migration playbook templates',
        icon: BookOpen,
        category: 'navigation',
        action: nav('/rationalization/playbooks'),
        keywords: ['migration', 'template', 'strategy'],
      },
      {
        id: 'nav-projects',
        label: 'Go to Projects',
        description: 'Migration project tracking',
        icon: FolderKanban,
        category: 'navigation',
        action: nav('/rationalization/projects'),
        keywords: ['migration', 'tracking', 'progress'],
      },
      {
        id: 'nav-marketplace',
        label: 'Go to Marketplace',
        description: 'Browse connectors and templates',
        icon: Store,
        category: 'navigation',
        action: nav('/marketplace'),
        keywords: ['connectors', 'plugins', 'store'],
      },
      {
        id: 'nav-templates',
        label: 'Go to Industry Templates',
        description: 'Pre-built solution templates',
        icon: LayoutTemplate,
        category: 'navigation',
        action: nav('/templates'),
        keywords: ['industry', 'vertical', 'prebuilt'],
      },
      {
        id: 'nav-agent-hub',
        label: 'Go to Agent Hub',
        description: 'Agent orchestration and monitoring',
        icon: Bot,
        category: 'navigation',
        action: nav('/agent-hub'),
        keywords: ['orchestration', 'ai', 'agents'],
      },
      {
        id: 'nav-data-products',
        label: 'Go to Data Products',
        description: 'Data product catalog',
        icon: Package,
        category: 'navigation',
        action: nav('/data-products'),
        keywords: ['catalog', 'data', 'subscribe'],
      },
      {
        id: 'nav-immune-system',
        label: 'Go to Immune System',
        description: 'Self-healing infrastructure monitoring',
        icon: HeartPulse,
        category: 'navigation',
        action: nav('/operations/immune-system'),
        keywords: ['health', 'resilience', 'healing'],
      },
      {
        id: 'nav-ai-assistant',
        label: 'Go to AI Assistant',
        description: 'Full-page AI chat interface',
        icon: Sparkles,
        category: 'navigation',
        action: nav('/ai'),
        keywords: ['chat', 'copilot', 'help'],
      },
      {
        id: 'nav-pricing',
        label: 'Go to Pricing',
        ...
        category: 'navigation',
        action: nav('/pricing'),
        keywords: ['billing', 'plans', 'upgrade'],
      },
